		...
		if ( '' === $current_section ) {
			$settings = apply_filters(
				...
				array(
					...
					array(
						'title' => __( 'Trang thiết lập', 'woocommerce' ),
					...
					array(
						'title'    => __( 'Thanh toán', 'woocommerce' ),
						/* Translators: %s Page contents. */
					...
					array(
						'title'    => __( 'Tài khoản của tôi', 'woocommerce' ),
						/* Translators: %s Page contents. */
					...
					array(
						'title'    => __( 'Xem đơn hàng', 'woocommerce' ),
					...
					array(
						'title'    => __( 'Sửa tài khoản', 'woocommerce' ),
					...
					array(
						'title'    => __( 'Đăng xuất', 'woocommerce' ),
