...
if ( ! class_exists( 'WC_Email_Customer_Processing_Order', false ) ) :
	...
	class WC_Email_Customer_Processing_Order extends WC_Email {
		...
		public function get_default_subject() {
			return __( 'Đơn hàng của bạn đã được nhận.', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Cảm ơn bạn đã đặt hàng của bạn', 'woocommerce' );
		}
		...
		public function get_default_additional_content() {
			return __( 'Cảm ơn đã sử dụng {site_url}!', 'woocommerce' );
		}
	}
