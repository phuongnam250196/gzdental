<?php /* Template Name: Thư viện */ get_header("main"); ?>
                    ...
                    <div class="blog-wrapper" id="main">
                        ...
                        <div class="site-content" id="primary">
                            ...
                            <div role="main" id="content">
                                ...
                                <div class="row masonry-container" style="position: relative; height: 1274px;">
                                ...
                                <?php 
                                        ...
                                        if($query->have_posts()) : while($query->have_posts()) : $query->the_post();$i++; 
                                            ...
                                            <div class="col-md-6 col-sm-6 item" style="position: absolute; left: 0px; top: 0px;">
