...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="table-responsive">
		<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents data-table cart-table" id="shopping-cart-table">
			<thead>
				<tr class="first last">
								...
								<?php
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											...
											esc_html__( 'Xóa sản phẩm', 'woocommerce' ),
											esc_attr( $product_id ),
					...
					<tr>
						<td colspan="6" class="a-right last">
							<div class="cart-update-coupon">
								...
								<button type="submit" class="btn-update button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
							</div>
