...
<p><?php printf( esc_html__( 'Thanh toán cho đơn hàng #%1$s từ %2$s đã thất bại. Thứ tự như sau:', 'woocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ); ?></p>
